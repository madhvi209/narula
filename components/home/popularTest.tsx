...
export default function FrequentlyBooked({ className }: { className?: string }) {
    return (
        <div
            className={cn(
                "w-full flex flex-col gap-5 px-2 sm:px-4 py-8 mb-6", // added mb-10 for bottom margin
                className
            )}
            // style={{
            //     background: `linear-gradient(120deg, ${BLUE_200} 70%, ${BLUE_100} 100%)`
            // }}
        >
            {/* Heading */}
                    ...
                    >
                        ...
                        >
                            <span className="flex items-center gap-1">
                                ...
                                <span className="text-xs font-medium ml-1">Add</span>
                            </span>
                        </button>
                        {/* Only the button itself triggers its hover effect */}
                        <style>
                        {`
